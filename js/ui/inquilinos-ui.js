...
function renderInquilinosTable() {
    ...
    setTimeout(() => {
        ...
        // ── MOBILE: Card list ──
        _renderInquilinosMobileCards(sortedInquilinos, mobileDiv);
    }, 100);
}
...
function filtrarInquilinos(query) {
    ...
    // Mobile cards
    var mobileDiv = document.getElementById('inquilinosMobileCards');
    if (mobileDiv) _renderInquilinosMobileCards(filtrados, mobileDiv);
}
...
// editInquilino → en main.js
// contacto functions → en inquilino-modals.js
// viewContrato/viewDocumento → en main.js / db-fetch-docs.js
